...
public class BluetoothLeService extends Service {
    ...
    public static final int GATT_CONNECTED = 3;
    public static final int GATT_DISCONNECT = 4;
    public static final int GATT_SERVICES_DISCOVERED = 5;
    public static final int GATT_CHARACTERISTIC_READ = 6;
    ...
    public void setActivityHandler(android.os.Handler handler) { mActivityHandler = handler;
    }
    ...
    public void writeCustomCharacteristic(int value) {
        ...
        if(mBluetoothGatt.writeCharacteristic(mWriteCharacteristic) == true){
            Log.w(TAG, "Write Char Successful");
        }
    }
}
