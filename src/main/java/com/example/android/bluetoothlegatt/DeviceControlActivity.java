...
public class DeviceControlActivity extends Activity {
    ...
    //values for calculation of moving average of RSSI
    int j=0;
    int[] myIntArray = new int[10];

    //values for alarm RSSI threshold selection
    int step =10;
    int max=-75;
    int min=-95;
    double value=-85;
...
//This message handler will be called when BluetoothLeService gets results back from the Gatt server.
    ...
    public ExpandableListView.OnChildClickListener getServicesListClickListener() {
        return servicesListClickListner;
    }


    //timer to read RSSI every 5 milliseconds.
